...
def train(args):
    ...
    if args.use_ram:
        if args.train_type == 'measure':
            ...
            val_dataset = MRIDataset2_2(args.val_image_path, proportion=0.5)
        else:
            train_dataset = MRIDataset2(args.train_image_path, args.proporation)
            val_dataset = MRIDataset2(args.val_image_path, proportion=0.5)

    else:
        if args.train_type == 'measure':
            # train_dataset = MRIDataset1_2(args.train_image_path, args.proporation)
            # val_dataset = MRIDataset1_2(args.val_image_path, proportion=0.5)
            ...
            val_dataset = MRIDataset1(args.val_image_path, proportion=0.5)
